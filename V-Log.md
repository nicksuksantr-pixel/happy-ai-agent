...
| Version | สรุป |
|---|---|
| **v2.8.3** | **Security: ปิด PAT-in-exe** (audit A3#2) — ทำ update-repo เป็น **public** (Nick เลือก) → เอา `.env`/token ออกจาก bundle · updater ทำงาน token-less · token เก่าไร้ค่า (ไม่ revoke — กัน client เก่า 401) · git history scan สะอาด |
...
— อัปเดตล่าสุด: 2026-06-04 (v2.8.3, Coddy) · git log = ฉบับ authoritative
